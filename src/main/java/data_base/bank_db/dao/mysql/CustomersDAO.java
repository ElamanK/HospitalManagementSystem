...
import data_base.bank_db.dao.dao_interfaces.ICustomersDAO;
...
public class CustomersDAO implements ICustomersDAO {
    ...
    @Override
    public void updateEntity(int id, Customers entity) {
        Connection connection = ConnectionPool.getInstance().getConnection();
    ...
    @Override
    public Customers createEntity(Customers entity) {
        Connection connection = ConnectionPool.getInstance().getConnection();
